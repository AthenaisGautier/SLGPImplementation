...
\CommentTok{\# Histogram: Distribution of med by \textquotesingle{}AGE\textquotesingle{} bin}
\NormalTok{hist\_plot }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ medv)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Median value of owner{-}occupied homes [MEDV, k$]"}\NormalTok{, }
       ...
       \AttributeTok{title =} \StringTok{"Histogram of median housing values by \textquotesingle{}AGE\textquotesingle{} group"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
...
\FunctionTok{ggplot}\NormalTok{()  }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{y =} \StringTok{"Proportion of owner{-}occupied units built prior to 1940 [AGE, \%]"}\NormalTok{, }
       ...
       \AttributeTok{title =} \StringTok{"Samples from the SLGP Prior for the pdfs of \textquotesingle{}MEDV\textquotesingle{} at AGE, visualised across slices"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ medv)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Median value of owner{-}occupied homes [MEDV, k$]"}\NormalTok{, }
       \AttributeTok{y =} \StringTok{"Probability density"}\NormalTok{, }
       \AttributeTok{title =} \StringTok{"Binned \textquotesingle{}MEDV\textquotesingle{} histograms by \textquotesingle{}AGE\textquotesingle{} (width = 5) VS three SLGP prior draws at bins centers"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
...
\FunctionTok{ggplot}\NormalTok{()  }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{y =} \StringTok{"Proportion of owner{-}occupied units built prior to 1940 [AGE, \%]"}\NormalTok{, }
       \AttributeTok{x =} \StringTok{"Median value of owner{-}occupied homes [MEDV, k$]"}\NormalTok{,}
       \AttributeTok{title =} \StringTok{"Samples from SLGP Priors with varying smoothnesses for the pdfs of \textquotesingle{}MEDV\textquotesingle{} at AGE, visualised across slices"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{geom\_ribbon}\NormalTok{(}\AttributeTok{data=}\NormalTok{predPrior,}
              \AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{medv, }\AttributeTok{ymax=}\NormalTok{scale\_factor}\SpecialCharTok{*}\NormalTok{value}\SpecialCharTok{+}\NormalTok{age, }
                          \AttributeTok{ymin=}\NormalTok{age, }\AttributeTok{group=}\SpecialCharTok{{-}}\NormalTok{age, }\AttributeTok{fill=}\NormalTok{age),}
...
\FunctionTok{ggplot}\NormalTok{()  }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{y =} \StringTok{"Proportion of owner{-}occupied units}\SpecialCharTok{\textbackslash{}n}\StringTok{built prior to 1940 [\%]"}\NormalTok{, }
       \AttributeTok{x =} \StringTok{"Median value of owner{-}occupied homes [MEDV, k$]"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ medv)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Median value of owner{-}occupied homes [MEDV, k$]"}\NormalTok{, }
       \AttributeTok{y =} \StringTok{"Probability density"}\NormalTok{, }
       \AttributeTok{title =} \StringTok{"Binned \textquotesingle{}MEDV\textquotesingle{} histograms by \textquotesingle{}AGE\textquotesingle{} (width = 5) VS SLGP{-}MAP estimators at bins centers"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position=}\StringTok{"bottom"}\NormalTok{,}
        \AttributeTok{legend.direction =} \StringTok{"horizontal"}\NormalTok{,}
        \AttributeTok{legend.title =} \FunctionTok{element\_blank}\NormalTok{())}\SpecialCharTok{+}
...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(logPostData))}\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Trained and evaluated on full dataset."}\NormalTok{)}\SpecialCharTok{+}
...
\CommentTok{\#\textgreater{} Ncells 2283313 122.0    4704905 251.3  4704905 251.3}
\CommentTok{\#\textgreater{} Vcells 6771079  51.7   23665765 180.6 28206018 215.2}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ medv)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Median value of owner{-}occupied homes [MEDV, k$]"}\NormalTok{, }
       \AttributeTok{y =} \StringTok{"Probability density"}\NormalTok{, }
       \AttributeTok{title =} \StringTok{"Binned \textquotesingle{}MEDV\textquotesingle{} histograms by \textquotesingle{}AGE\textquotesingle{} (width = 5) VS SLGP{-}Laplace draws at bins centers"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{xlim=}\NormalTok{range\_response,}
                  \AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.2}\NormalTok{))}
\end{Highlighting}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ medv)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Median value of owner{-}occupied homes [MEDV, k$]"}\NormalTok{, }
       \AttributeTok{y =} \StringTok{"Probability density"}\NormalTok{, }
       \AttributeTok{title =} \StringTok{"Binned \textquotesingle{}MEDV\textquotesingle{} histograms by \textquotesingle{}AGE\textquotesingle{} (width = 5) VS SLGP{-}MCMC draws at bins centers"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{xlim=}\NormalTok{range\_response,}
                  \AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.2}\NormalTok{))}
\end{Highlighting}
...
\FunctionTok{ggplot}\NormalTok{(df\_plot, }\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ age)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Proportion of owner{-}occupied units built prior to 1940 [AGE, \%]"}\NormalTok{, }
       \AttributeTok{y =} \StringTok{"Moment value"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{xlim=}\NormalTok{range\_x,}
                  \AttributeTok{ylim=}\NormalTok{range\_response)}
\end{Highlighting}
...
\CommentTok{\# Histogram: Distribution of rad by \textquotesingle{}AGE\textquotesingle{} bin}
...
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Index of accessibility to radial highways [RAD]"}\NormalTok{, }
       ...
       \AttributeTok{title =} \StringTok{"Binned \textquotesingle{}RAD\textquotesingle{} histograms by \textquotesingle{}AGE\textquotesingle{} (blue bars) VS SLGP{-}MAP estimators at bins centers (red hashed bars)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{xlim=}\NormalTok{range\_response,}
                  \AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}
