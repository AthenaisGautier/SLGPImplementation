...
* Exponential Kernel: A special case of the Matérn class (ν = 1/2) that results in less smooth realizations.
...
```{r SLGPMCMCplot, fig.cap = "Predictive probability density (and draws from a MCMC) of medv at age, seen over 3 slices.", fig.fullwidth=TRUE, fig.height=4, fig.width=8, fig.align='center',fig.pos="H", eval=FALSE}
# Define the three selected values
